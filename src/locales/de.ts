...
export const de: MPLocale = {
  ...
  messages: {
    ...
    numberField: { increase: 'Erhöhen', decrease: 'Verringern' },
    carousel: {
      label: 'Karussell',
    ...
    chart: { label: 'Diagramm', table: 'Diagrammdaten', category: 'Kategorie', total: 'Gesamt' },
    sparkline: { summary: '{count} Punkte, von {first} bis {last}' },

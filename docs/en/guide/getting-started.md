...
| 5                      | 20.8 kB         | 7.6 kB                   |
| 10                     | 20.8 kB         | 10.4 kB                  |
| 38 or more             | 20.8 kB         | 20.8 kB and climbing     |
...
| --------------------- | ---------- | ----------------- |
| `MPBox` alone         | 1.7 kB     | 4.6 kB            |
| `MPButton` alone      | 3.0 kB     | 4.6 kB            |
| Five components       | 9.0 kB     | 7.6 kB            |
| Ten components        | 13.3 kB    | 10.4 kB           |
| Every export there is | 126.8 kB   | 20.8 kB           |

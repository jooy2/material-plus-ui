...
넘긴 클래스는 컴포넌트 자신의 클래스 뒤에 붙고, 자리를 내주기 위해 지워지는 것은 없습니다. 그래서 **같은 속성을 지정하는 두 유틸리티는 어느 쪽을 썼는지가 아니라 스타일시트가 결정합니다.**
...
| `MPButton` 하나  | 2.9 kB     | 4.5 kB           |
| 컴포넌트 다섯 개 | 7.4 kB     | 6.6 kB           |
| 컴포넌트 열 개   | 11.2 kB    | 9.1 kB           |
| 백열한 개 전부   | 74.2 kB    | 16.2 kB          |

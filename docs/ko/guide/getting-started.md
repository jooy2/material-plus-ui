...
| ---------------- | ---------- | ---------------- |
| `MPBox` 하나     | 0.7 kB     | 4.0 kB           |
| `MPButton` 하나  | 3.0 kB     | 4.5 kB           |
| 컴포넌트 다섯 개 | 8.0 kB     | 7.1 kB           |
| 컴포넌트 열 개   | 12.3 kB    | 9.9 kB           |
| 내보내는 것 전부 | 86.4 kB    | 17.5 kB          |
...
Base UI는 실제 다운로드의 더 큰 절반이고 두 열 어디에도 들어 있지 않습니다. 함께 번들하면 컴포넌트 다섯 개는 19.3 kB, 열 개는 92.0 kB가 됩니다. 다만 peer dependency이므로 그것을 쓰는 다른 것들과 공유되고, 버전은 여러분이 정합니다.
